...
def setOption(ligne_utile_sum, ligne_avant_sum, ligne_utile_min, ligne_avant_min, ligne_utile_mean, ligne_avant_mean, ligne_utile_max, ligne_avant_max):
    ...
    option_afficher= "(ratio: " + str(ligne_utile_sum) + " [~" + str(ligne_utile_mean) + ", -" + str(ligne_utile_min) + ", +" + str(ligne_utile_max) + "] / " + str(ligne_avant_sum) + " [~" + str(ligne_avant_mean) + ", -" + str(ligne_avant_min) + ", +" + str(ligne_avant_max) + "]): " + str(calcule) + "%"
...
def DemiLigne(ligne_utile, ligne_avant):
    ...
    if (ligne_avant_max*delta_max > ligne_utile_max > ligne_avant_max*delta_min) or (ligne_avant_sum*delta_max > ligne_utile_sum > ligne_avant_sum*delta_min):
        return True
    ...
    # Le "else" permet de faire les préparations pour les autres calcules:
        ...
        if (ligne_utile_sum < 100*coefficient_resolution and ligne_avant_sum < 100*coefficient_resolution) and ((ligne_utile_max <= 1 and ligne_avant_max <= 1) or (ligne_avant_mean-0.0095 <= ligne_utile_mean <= ligne_avant_mean+0.0095)):
            return True
        ...
        # Le "else" permet de faire les préparations pour les autres calcules:
            ...
            if (ligne_utile_sum < ligne_utile.size and ligne_avant_sum < ligne_utile.size) and (ligne_utile_min == 0 and ligne_avant_min == 0) and (ligne_utile_mean < 0.35 and ligne_avant_mean < 0.35) and (ligne_utile_max < 20 and ligne_avant_max < 20) and (ligne_avant_max/ligne_utile_max < 1.5):
                return True
